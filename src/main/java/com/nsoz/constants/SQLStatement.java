...
public class SQLStatement {
    ...
    public static final String GET_USER = "SELECT `status`, `id`, `luong`, `last_attendance_at`, `received_first_gift`, `password`, `ip_address`, `level_reward`, `role`, `kh`, `efffan`, `effvip`, `efftop`, `effytb`, `effdg`, `effygt`, `effydc`, `nhanmocnap`, `effydh`, `online`, `ban_until`, `activated` FROM `users` WHERE `username` = ?;";
